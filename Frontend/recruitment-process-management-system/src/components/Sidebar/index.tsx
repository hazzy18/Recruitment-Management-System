...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      <h1 className='text-lg pt-5 pl-5'>Recruitment System</h1>
      {/* <!-- SIDEBAR HEADER --> */}
                        ...
                        <ul className="mb-5.5 flex flex-col gap-1 pl-6">
                          <li>
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 mt-3 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
...
{isRoleAllowed(["HR","Admin","Recruiter"]) &&( 
